...
VALUES 
(1,2, 'url','For me, money is not my definition of success. Inspiring people is a definition of success.'),
(2,3, 'url', 'Success is not the key to happiness. Happiness is the key to success. If you love what you are doing, you will be successful.'),
(3,6, 'url', 'Coming together is a beginning; keeping together is progress; working together is success.'),
(4,5, 'url', 'However difficult life may seem, there is always something you can do and succeed at.'),
(5,3, 'url', 'I still think I am the greatest.'),
(6,1, 'url', 'Keep your nose out the sky, keep your heart to god, and keep your face to the raising sun.'),
(7,1, 'url', 'If you have the opportunity to play this game of life you need to appreciate every moment. a lot of people don’t appreciate the moment until it’s passed.'),
(8,1, 'url', 'I feel like I’m too busy writing history to read it.'),
(9,1, 'url', 'Know your worth! People always act like they’re doing more for you than you’re doing for them.'),
